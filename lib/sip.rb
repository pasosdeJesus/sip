...
module Sip
    ...
    # @param string tipoarchivo 'cambia' o 'datos' para indicar si se carga
    #     cambia-basica.sql o datos-basica.sql. El primero debería tener cambios
    ...
    def self.carga_semillas_sql(conexion, motor, tipoarchivo)
      if (tipoarchivo.to_s != 'datos' && tipoarchivo.to_s != 'cambia')
        raise 'Las semillas solo pueden ser cambia o datos'
      end
      if motor 
